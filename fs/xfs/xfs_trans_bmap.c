 ...
 * be logged as needing to be mapped or unmapped into a file.  It
 * should be called once for each extent to be mapped or unmapped.
 */
STATIC void
	...
	xfs_exntst_t			state)
{
	...
	xfs_trans_set_bmap_flags(bmap, type, whichfork, state);
}
